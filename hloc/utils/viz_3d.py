...
def plot_reconstruction(
        ...
        camcolor: str = 'rgba(208, 125, 130, 0.5)',
        pointcolor: str = 'rgb(255, 0, 0)',
        name: Optional[str] = None,
    ...
    if points:
        plot_points(fig, np.array(xyzs), color=pointcolor, ps=1, name=name)
    if cameras:
        plot_cameras(fig, rec, color=camcolor, legendgroup=name, size=cs)
